...
?>
		...
		<form method="post" action="admin_member_update.php?num=<?=$num?>">
			...
			<span class="col8"><button type="button" onclick="location.href='admin_member_delete.php?num=<?=$num?>&id=<?=$id?>'">퇴출</button></span>
			<!--관리자 권한으로 삭제시 추가 처리 수정 -->
		</form>
		</li>	
