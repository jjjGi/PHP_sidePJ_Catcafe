...
<?php
	...
	if ($mode=="send"){
		///////////////////////////////////////////////////////////////////////////////////////////////////////////송,수신 분할수정
		$sql = "select * from sendmessage where send_id='$userid' order by num desc";
	}
	else{
		
		$sql = "select * from receivemessage where rv_id='$userid' order by num desc";
		////////////////////////////////////////////////////////////////////////////////////////////////////////////
	}
	...
	if ($total_record % $scale == 0)     
		...
		$total_page = floor($total_record/$scale) + 1; 		//php는 실수연산을하기때문에 floor함수로 내림해야한다. 
